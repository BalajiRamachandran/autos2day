...
<!-- 	<tr class="form-field">
		<th scope="row"><label for="dealership-id"><?php _e('Dealership ID') ?></label></th>
		<td><label name="dealership-name" type="text" id="dealership-name" class="code" value="<?php echo esc_attr($new_user_uri); ?>" /></td>
	</tr>

	<tr class="form-field">
		<th scope="row"><label for="dealership-name"><?php _e('Dealership Name') ?></label></th>
		<td><input name="dealership-name" type="text" id="dealership-name" class="code" value="<?php echo esc_attr($new_user_uri); ?>" /></td>
	</tr>

	<tr class="form-field">
		<th scope="row"><label for="address-line1"><?php _e('Address Line 1') ?></label></th>
		<td><input name="address-line1" type="text" id="address-line1" class="code" value="<?php echo esc_attr($new_user_uri); ?>" /></td>
	</tr>

	<tr class="form-field">
		<th scope="row"><label for="address-line2"><?php _e('Address Line 2') ?></label></th>
		<td><input name="address-line2" type="text" id="address-line2" class="code" value="<?php echo esc_attr($new_user_uri); ?>" /></td>
	</tr>

	<tr class="form-field">
		<th scope="row"><label for="address-city"><?php _e('City') ?></label></th>
		<td><input name="address-city" type="text" id="address-city" class="code" value="<?php echo esc_attr($new_user_uri); ?>" /></td>
	</tr>

	<tr class="form-field">
		<th scope="row"><label for="address-state"><?php _e('State') ?></label></th>
		<td><input name="address-state" type="text" id="address-state" class="code" value="<?php echo esc_attr($new_user_uri); ?>" /></td>
	</tr>

	<tr class="form-field">
		<th scope="row"><label for="address-country"><?php _e('Country') ?></label></th>
		<td><input name="address-country" type="text" id="address-country" class="code" value="<?php echo esc_attr($new_user_uri); ?>" /></td>
	</tr>

	<tr class="form-field">
		<th scope="row"><label for="dealership-phone"><?php _e('Phone No') ?></label></th>
		<td><input name="dealership-phone" type="text" id="dealership-phone" class="code" value="<?php echo esc_attr($new_user_uri); ?>" /></td>
	</tr>

	<tr class="form-field">
		<th scope="row"><label for="dealership-eff-date"><?php _e('Effective Date') ?></label></th>
		<td><input name="dealership-eff-date" type="text" id="dealership-eff-date" class="code" value="<?php echo esc_attr($new_user_uri); ?>" /></td>
	</tr>

	<tr class="form-field">
		<th scope="row"><label for="tax-id"><?php _e('Tax ID') ?></label></th>
		<td><input name="tax-id" type="text" id="tax-id" class="code" value="<?php echo esc_attr($new_user_uri); ?>" /></td>
	</tr>

	<tr class="form-field">
		<th scope="row"><label for="dealership-lic-no"><?php _e('License No') ?></label></th>
		<td><input name="dealership-lic-no" type="text" id="dealership-lic-no" class="code" value="<?php echo esc_attr($new_user_uri); ?>" /></td>
	</tr> -->
