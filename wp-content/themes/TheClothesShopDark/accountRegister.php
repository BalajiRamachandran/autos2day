...
get_header(); ?>
	...
	<script type="text/javascript">
		jQuery(document).ready(function(){
			var State = '<?php echo $VARS["dealership_address_state"];?>';
			if ( State != null || State != undefined ) {
				jQuery("option[value="+State+"]").attr("selected", "selected");
			}
	...
	<div class="registrationForm">
		...
		<table>
					<tr id="ad_pt1">
						...
						<td>
							<input type="text" id="createAccountEmail1" name="email" size="35" maxlength="50" value="<?php echo $VARS['email'];?>" onchange="showHint(this.value,'<?php echo is_in_subfolder();?>')"/ required>
						</td>
					</tr>		
<!-- 					<tr>
						<td>
 ...
 -->					<tr>
						...
						<td>
							<input type="text" id="contact" size="35" name="contact" value="<?php echo $VARS['contact'];?>" onkeyup="showUser(this.value,'<?php echo is_in_subfolder();?>')" required/>
						</td>
					</tr>
				<?php
					...
					<tr id="ad_pt<?php echo $id;?>">
						...
						<td>
							<?php
								...
								?>
									<select name="<?php echo $key;?>" id="<?php echo $key;?>" value="<?php echo $VARS[$key];?>" placeholder="ADDRESS_HOME_COUNTRY" required>
									  <option></option>
								...
								<?php
									...
									$required = "required";
									if ( $key == 'dealership_address_line_2' ) {
										$required = "";
									}
								?>

							<input type="text" id="<?php echo $key;?>" name="<?php echo $key;?>" size="35" maxlength="50" value="<?php echo $VARS[$key];?>" <?php echo $required;?>/>
							<?php } ?>
						</td>
					</tr>
	 			   <?php
