...
// display the products
	...
	<div class="<?php echo $the_div_class;?>">
		...
		if ( strlen(get_option("wps_num_of_deals_per_page")) > 0 ) 
		{
			$args['posts_per_page'] = get_option("wps_num_of_deals_per_page");
			$args['post_count'] = get_option("wps_num_of_deals_per_page");
		}
		// $args['orderby'] = 'rand';
		// ASC = low to high / old to new
		if ( get_option("wps_sorting_order") == 'price_low_to_high' ) 
		{
			$args['order'] = 'ASC';
			$args['orderby'] = 'meta_value';
			$args['meta_key'] = 'ad_price';
			$args['orderby'] = 'meta_value_num';		
		} elseif (get_option("wps_sorting_order") == 'price_high_to_low') 
		{
			$args['order'] = 'DESC';
			$args['orderby'] = 'meta_value';
			$args['meta_key'] = 'ad_price';
			$args['orderby'] = 'meta_value_num';		
		} elseif (get_option("wps_sorting_order") == 'date_old_to_new') 
		{
			$args['order'] = 'ASC';
		} elseif (get_option("wps_sorting_order") == 'date_new_to_old') 
		{
			$args['order'] = 'DESC';
		} elseif (get_option("wps_sorting_order") == 'random') 
		{
			$args['orderby'] = 'rand';
		}
