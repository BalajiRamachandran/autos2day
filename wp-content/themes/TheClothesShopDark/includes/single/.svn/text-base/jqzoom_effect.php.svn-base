...
if(!empty($videoMatches[1][0])) { 
	if($OPTION['wps_imagesTab_enable']) { ?>
		...
		<ul class="thumbTabs videotabs noprint">
			<li><a class="imagesTab" href="#"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/socialIcons/Photo-trans.png" alt="<?php _e('Product Image','wpShop'); ?>"/><?php echo $OPTION['wps_imagesTabText']; ?></a></li>
