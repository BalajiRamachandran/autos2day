		...
		<div class="contentWrap mediaPanes">
			...
			if($OPTION['wps_imagesTab_enable']) { ?>
				<div class="theProdMedia innerProdMedia clearfix">
					...
					if($num != 0){ ?>
						<a href="<?php echo $data[0]['guid']; ?>" class="MagicZoom" id="zoom1" rel="show-title: false; zoom-fade: true; zoom-position: inner; selectors-change:mouseover; selectors-effect:fade;">
							<img src="<?php echo $imgURL[0];?>" alt="<?php echo $data[0]['post_title']; ?>"/></a>
					<?php } else { ?>
...
if(empty($videoMatches[1][0])) { 
	...
	<div class="<?php echo $the_div_class;?>">
		<div class="contentWrap">
			<?php if($num != 0){ ?>
				<a href="<?php echo $data[0]['guid']; ?>" class="MagicZoom" id="zoo1" rel="show-title: false; zoom-fade: false; zoom-position: top; zoom-align: right; selectors-change:mouseover; selectors-effect:fade;"><img src="<?php echo $imgURL[0];?>" alt="<?php echo $data[0]['post_title']; ?>"/></a>
			<?php } else { ?>
				<a href="<?php echo $img_src; ?>" class="MagicZoom" id="zoom" rel="show-title: false; zoom-fade: true; zoom-position: top; selectors-change:mouseover; selectors-effect:fade;"><img src="<?php echo $imgURL;?>" alt="<?php echo wp_specialchars( get_the_title($post->ID), 1 ); ?>"/></a>
			<?php } ?>
		</div>
	</div><!-- c_box  -->
<?php } ?>