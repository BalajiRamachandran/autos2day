			...
			<div class="contentWrap">
				...
				//if we don't have any then display an image
					...
					<a href="<?php echo get_category_link($mainCategory->term_id);?>">
						<img src="<?php echo $OPTION['siteurl' ];?>/<?php echo $OPTION['upload_path'];?>/<?php echo $mainCategory->slug; ?>_alt.<?php echo $OPTION['wps_catimg_file_type']; ?>" alt="<?php echo $mainCategory->name; ?>" />
					</a>
				<?php } 
