...
*/
// 
add_option("disable_payment_processing", "1");
$user = wp_get_current_user();
if ( get_option("disable_payment_processing") == "0" ) {
	$AUTH_NET_PROFILE = get_user_meta ($user->ID, "customerProfileId", true);
}

// if ( is_user_logged_in() && ! current_user_can( 'administrator' ) ) {
// 	if (  strpos($_SERVER['REQUEST_URI'], "myaccount=1&action=4") === false ) {
// 		include (TEMPLATEPATH . '/lib/pages/authn/validate_authn.php');
// 	}	
// }
