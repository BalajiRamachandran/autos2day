...
function create_my_taxonomies() {
	...
	if($OPTION['wps_shopBySelection_option']) {
		register_taxonomy( __('selection', 'wpShop'), 'post', array( 'hierarchical' => false, 'label' => __('Selections', 'wpShop'), 'query_var' => __('selection', 'wpShop'), 'rewrite' => array( 'slug' => __('selections', 'wpShop') ) ) );
	}
